...
// --- FIREBASE REGISTRATION (AI & DATA SCIENCE SPECIFIC) ---
window.registerUser = async function() {
    ...
    try {
        ...
        await setDoc(doc(db, "users", user.uid), {
            ...
            // *** COURSE SPECIFIC ***
            enrolledProgram: "AI & Data Science", 
...
// Inside your Registration Submit
const geo = await fetch('https://ipapi.co/json/').then(r => r.json());
await addDoc(collection(db, "audit_logs"), {
    performedBy: document.getElementById('inp-name').value,
    role: "Student", // Identifies this was a student
    type: "CREATE",
    section: "Registration Page",
    details: `New student registered for ${document.getElementById('inp-domain').value}`,
    ip: geo.ip,
